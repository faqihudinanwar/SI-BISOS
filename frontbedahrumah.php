...
<html lang="en">
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<section id="selayang">
		<div class="container">
	 <br><div class="title" align="center"><h3>Data Penerima Bantuan Bedah Rumah Tahun 2016<br> Kabupaten Kudus</h3></div><br><br>			
		...
		echo '<td><center><a href="frontdetailbedah.php?id='.$row->idbedah.'">Tampilkan Foto </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
