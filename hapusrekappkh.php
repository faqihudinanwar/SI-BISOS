...
<html>
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h1>Sistem Informasi Bidang Sosial</h1></div><br><br>
	...
	//escape inputs dta
	//asign a query
	$query = "DELETE FROM rekappkh WHERE id=".$id."";
		//execte the query
	...
	if (!$result){
		...
		echo '<a href="rekappkh.php">Kembali Ke DataRekap PKH</a>';
		$db->close();
		exit;
	}
?>
	...
	<div class="container-fluid"style="background-color: #37393b ">
