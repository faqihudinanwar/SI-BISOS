			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2 text-center">
						<h2 class="section-heading">PEMBUATAN KARTU KUNING / AK I</h2>
						<hr class="primary">
						<p style="text-align:justify;">Syarat Pembuatan AK.I / Kartu Pencari Kerja :
							<ol type="a" style="text-align:justify;">
								<li> Fotocopy Ijazah Terakhir  sebanyak 1 Lembar</li>
								<li> Fotocopy KTP  sebanyak 1 Lembar</li>
								<li> Pas Foto (2x3)  sebanyak 2 Lembar</li>
								<li> Stopmap (Kuning) untuk Laki - laki</li>
								<li> Stopmap (Hijau) untuk Perempuan</li>
							</ol>
						</p>
						
						<p style="text-align:justify;">Jam Pelayanan Pembuatan AK I: </p>
							<table style="text-align : left; width:50%; font-size:15px;">
								<tr>
									<td>SENIN - KAMIS</td>
									<td>:</td>
							...
							<br />
						<p style="text-align:center; font-weight:bold;">ALUR PEMBUATAN KARTU KUNING / AK I </p>
						<img src="img/alurak1.png" alt="alurak1" style="width:700px;" >
					</div>
				</div>
			</div>
		</section>
