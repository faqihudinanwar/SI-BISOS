		...
		<section>
			<form>
				...
				<ul>
						...
						<a href="posting_artikel.php">Kembali</a>
				...
				<tr>
					...
					<?php
						...
						//Asign a query
						$query = "SELECT file.idfile, file.nama, file.file, file.files FROM file WHERE idfile = '".$id."' ";
						// Execute the query
						...
						if($row->file == ''){
							$file = 'Belum diunggah';
							$aksi_file = "<a href= 'formfile.php?tar=file'>Unggah</a>";
						} else{
							$file = 'Sudah diunggah';
							$aksi_file = "<a href= 'hapusfile.php?tar=file'>Hapus</a>";
						}	
						if($row->files == ''){
							$files = 'Belum diunggah';
							$aksi_files = "<a href= 'formfile.php?tar=files'>Unggah</a>";
						} else{
							$files = 'Sudah diunggah';
							$aksi_files = "<a href= 'hapusfile.php?tar=files'>Hapus</a>";
						}
							echo '<tr>';
							echo '<td><center>Bedah Rumah</center></td>';
							echo '<td><center>'.$file.'</center></td>'; 
							echo '<td><center>'.$aksi_file.'</center></td>';
							echo '</tr>';
							echo '<tr>';
							
							echo '<tr>';
							echo '<td><center>Santunan Kematian</center></td>';
							echo '<td><center>'.$files.'</center></td>'; 
							echo '<td><center>'.$aksi_files.'</center></td>';
							echo '</tr>';
							echo '<tr>';
