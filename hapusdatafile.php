...
<html>
	...
	<body>
		...
		<div id="wrapper">
			<div id="sidebar-wrapper" style="font-family: Comic Sans MS; ">
				...
				<li>
				<li>
                        <a href="galeri"style="color: #c6e2f4;"><span class="glyphicon glyphicon-bell"></span> Galeri</a>
                    </li>
				</ul>
			</div>
	...
	//escape inputs dta
	//asign a query
	$query = "DELETE FROM file WHERE idfile=".$id."";
		//execte the query
	...
	if (!$result){
		...
		echo '<a href="posting_artikel.php">Kembali Ke Posting Artikel</a>';
		$db->close();
		exit;
	}
?>
