...
<html lang="en">
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<section id="selayang">
		<div class="container">
	 <br><div class="title" align="center"><h3>GALERI</h3></div><br><br>			
		...
		//assign a query
		$query = "SELECT galeri.idgambar, galeri.gambara, galeri.gambarb, galeri.gambarc, galeri.gambard, galeri.gambare FROM galeri ORDER BY idgambar ";
		//execute the query
		...
		echo'<tr>';
		echo "<center><img src = 'uploads/galeri/".$row->gambara."'width=\"300px\" height=\"200px\" />";
		echo "<img src = 'uploads/galeri/".$row->gambarb."'width=\"300px\" height=\"200px\" />";
		echo "<img src = 'uploads/galeri/".$row->gambarc."'width=\"300px\" height=\"200px\" />";
		echo "<img src = 'uploads/galeri/".$row->gambard."'width=\"300px\" height=\"200px\" />";
		echo "<img src = 'uploads/galeri/".$row->gambare."'width=\"300px\" height=\"200px\" />";
		echo '</tr>';
		$i++;
}
echo '</table>';
