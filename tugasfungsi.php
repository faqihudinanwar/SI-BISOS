...
<html lang="en">
	<head>
		...
		#searchbox input[type="text"] {
			background: url("img/search.png") no-repeat 10px 13px #f2f2f2;
		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<img alt="header dinas" src="img/header.png" style="width:300px; height:50px; padding:1px;"/>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2 text-center">
						<h2 class="section-heading">TUGAS DAN FUNGSI</h2>
						<hr class="primary">
						<p style="text-align:justify;text-indent:0.5in;">
						Dinas Sosial, Tenaga Kerja, dan Transmigrasi merupakan unsur pelaksana otonomi daerah di bidang sosial, 
						tenaga kerja, dan transmigrasi yang berkedudukan di bawah dan bertanggung jawab kepada Bupati melalui Sekretaris 
						Daerah. <br />
						<p style="text-align:justify;text-indent:0.5in;">
						Dinas Sosial, Tenaga Kerja, dan Transmigrasi mempunyai tugas pokok melaksanakan urusan pemerintahan daerah bidang 
						sosial, tenaga kerja, dan transmigrasi berdasarkan asas otonomi daerah dan tugas pembantuan.
						Untuk melaksanakan tugas pokok tersebut Dinas Sosial, Tenaga Kerja, dan Transmigrasi menyelenggarakan fungsi :
						<ol style="text-align:justify; font-size:16px;">
							<li>Perumusan kebijakan teknis bidang sosial, tenaga kerja, dan transmigrasi;</li>
							<li>Penyelenggaraan urusan pemerintahan dan pelayanan umum bidang sosial, tenaga kerja, dan transmigrasi;</li>
							<li>Pembinaan dan pelaksanaan tugas bidang sosial, tenaga kerja, dan transmigrasi;</li>
							<li>Pelaksanaan tugas di bidang sosial, pelayanan dan rehabilitasi sosial, penempatan tenaga kerja dan 
							transmigrasi, pengawasan ketenagakerjaan, hubungan industrial dan perselisihan ketenagakerjaan;</li>
							<li>Pemantauan, evaluasi dan pelaporan bidang sosial, tenaga kerja,dan transmigrasi;</li>
							<li>Pelaksanaan kesekretariatan dinas; dan</li>
