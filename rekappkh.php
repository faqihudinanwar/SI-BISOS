	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h3>Data Realisasi Pembayaran Bantuan Program keluarga Harapan (PKH)<br> Kabupaten Kudus</h3></div>
			<br>
				<ul>
						<i class="glyphicon glyphicon-plus"></i>
						<a href="tambahrekappkh.php">Tambah Data</a>
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th rowspan="2"><center>Triwulan</center></th>
					<th rowspan="2"><center>Kecamatan</center></th>
					<th colspan="2"><center>Alokasi Pembayaran</center></th>
					<th colspan="2"><center>Realisasi PT POS</center></th>
					<th colspan="6"><center>Aksi</center></th>
				</tr>
				<tr>
					<th><center>Jumlah RTSM</center></th>
		...
		//assign a query
		$query = "SELECT rekappkh.id, rekappkh.tahun, rekappkh.triwulan, kecamatan.kecamatan AS kecamatan, rekappkh.rtsm1, rekappkh.nominal1, rekappkh.rtsm2, rekappkh.nominal2 FROM rekappkh, kecamatan WHERE rekappkh.idkec=kecamatan.idkec ORDER BY id ";
		//execute the query
		...
		echo '<td><center>'.$row->triwulan.'</center></td>';
		echo '<td><center>'.$row->kecamatan.'</center></td>';
		echo '<td><center>'.$row->rtsm1.'</center></td>';
		echo '<td><center>'.$row->nominal1.'</center></td>';
		echo '<td><center>'.$row->rtsm2.'</center></td>';
		echo '<td><center>'.$row->nominal2.'</center></td>';
		echo '<td><center><a href="ubahkematian.php?id='.$row->id.'">ubah </center></a></td>';
		echo '<td><center><a href="hapusrekappkh.php?id='.$row->id.'">Hapus </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
