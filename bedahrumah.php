	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h3>Data Penerima Bantuan Bedah Rumah Tahun 2016<br> Kabupaten Kudus</h3></div>
				<ul>
						<i class="glyphicon glyphicon-plus"></i>
						<a href="tambahbedah.php">Tambah Data</a>
			...
			<table class="table table-hover table-condensed" >
				<tr>
					...
					<th><center>Jumlah Bantuan</center></th>
		...
		//assign a query
		$query = "SELECT bedahrumah.idbedah, bedahrumah.nama, bedahrumah.alamat, kecamatan.kecamatan AS kecamatan, bedahrumah.bantuan FROM bedahrumah, kecamatan WHERE bedahrumah.idkec=kecamatan.idkec ORDER BY idbedah ";
		//execute the query
		...
		echo '<td><center>'.$row->bantuan.'</center></td>';
		echo '<td><center><a href="ubahkematian.php?id='.$row->idbedah.'">ubah </center></a></td>';
		echo '<td><center><a href="unggahbedah.php?id='.$row->idbedah.'">unggah foto </center></a></td>';
		echo '<td><center><a href="hapusbedah.php?id='.$row->idbedah.'">Hapus </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
...
$db->close();
		?>
			...
			<a href="rekapbedah.php">Tampilkan Data Rekap Bedah Rumah</a>
			<i class="icon-angle-left"></i>
			<br><br>
			<i class="glyphicon glyphicon-save-file"></i>
			<a href="exportbedahrumah.php">Export ke Excel</a>
			<i class="icon-angle-left"></i> 
		</div>
