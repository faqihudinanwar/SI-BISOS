...
<html>
	...
	<body>
		...
		<!--Konten-->
		<section>
			<h3><center>Unggah Foto Galeri</center><br><br></h3>
			<ul>
						<td>
			...
			<form action="uploadgaleri.php" method="post" enctype="multipart/form-data" style="margin-left:500px; margin-top:50px;"/>
				<div>
					
					<tr>
						<td></td>
						<td colspan="3"><center>File yang diperbolehkan : jpg <br /><br /> </center></td></td>
						<td></td>
					</tr>
					<tr>
						<td><center><input type="hidden" name="MAX_FILE_SIZE" value="2000000" /></center></td>
						<td><center><label for="userfile">Unggah file :</label></center></td>
				...
				<a href = "galeri.php" id="tombol">Kembali</a>
