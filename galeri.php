	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h3>Galeri</br></br></h3></div>
				<ul>
						<i class="glyphicon glyphicon-plus"></i>
						<a href="tambahgaleri.php">Tambah Data</a>
		...
		//assign a query
		$query = "SELECT galeri.idgambar, galeri.nama FROM galeri ORDER BY idgambar ";
		//execute the query
		...
		echo '<td><center><a href="unggahgaleri.php?id='.$row->idgambar.'">Status Foto </center></a></td>';
		echo '<td><center><a href="hapusgaleri.php?id='.$row->idgambar.'">Hapus </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
