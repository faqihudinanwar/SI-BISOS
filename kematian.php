	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h3>Data Penerima Santunan Kematian Tahun 2014<br> Kabupaten Kudus</h3></div>
				<ul>
						<i class="glyphicon glyphicon-plus"></i>
						<a href="tambahkematian.php">Tambah Data</a>
			...
			<table class="table table-hover table-condensed" >
				<tr>
					...
					<th rowspan="2"><center>Nama Penerima</center></th>
					<th rowspan="2"><center>Ahli Waris</center></th>
					<th rowspan="2"><center>Alamat Penerima</center></th>
					<th rowspan="2"><center>Alamat Kecamatan</center></th>
					<th colspan="3"><center>Rincian Perhitungan</center></th>
		...
		//assign a query
		$query = "SELECT kematian.idpenerima, kematian.nama, kematian.ahliwaris, kematian.alamat, kecamatan.kecamatan AS kecamatan, kematian.volume, kematian.hargasatuan FROM kematian, kecamatan WHERE kematian.idkec=kecamatan.idkec ORDER BY idpenerima ";
		//execute the query
		...
		echo '<td><center>'.$row->ahliwaris.'</center></td>';
		echo '<td><center>'.$row->alamat.'</center></td>';
		echo '<td><center>'.$row->kecamatan.'</center></td>';
		echo '<td><center>'.$row->volume.'</center></td>';
		echo '<td><center>'.$row->hargasatuan.'</center></td>';
		echo '<td><center>'.$row->hargasatuan.'</center></td>';
		echo '<td><center><a href="ubahkematian.php?id='.$row->idpenerima.'">ubah </center></a></td>';
		echo '<td><center><a href="hapuskematian.php?id='.$row->idpenerima.'">Hapus </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
...
$db->close();
		?>
			...
			<a href="rekapkematian.php">Tampilkan Data Rekapitulasi Santunan Kematian</a>
			<i class="icon-angle-left"></i> 	
			<br><br>
