...
<html>
	...
	<body>
		...
		<!--Konten-->
		<section>
			<h3><center>Unggah Foto <?php $tar=$_GET['tar']; echo $tar;?> Bedah Rumah</center><br><br></h3>
			<ul>
						<td>
			...
			<form action="upload.php" method="post" enctype="multipart/form-data" style="margin-left:500px; margin-top:50px;"/>
				<div>
					
					<tr>
						<td></td>
						<td colspan="3"><center>File yang diperbolehkan : jpg atau jpeg <br /><br /> </center></td></td>
						<td></td>
					</tr>
					<tr>
						<td><center><input type="hidden" name="MAX_FILE_SIZE" value="200000" /></center></td>
