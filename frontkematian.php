...
<html lang="en">
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<section id="selayang">
		<div class="container">
	 <br><br><div class="title" align="center"><h3>Data Penerima Santunan Kematian Tahun 2014<br> Kabupaten Kudus</h3></div>				
			<br><br><table class="table table-hover table-condensed" >
				<tr>
