		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbar-collapse-1">
					...
					<li>
                        <a class="page-scroll" href="tautan.php">Tautan</a>
                    </li>
					</ul>
				</div>
			</div>
			...
			<div id="container">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2 text-center">
						<h2 class="section-heading">LOKASI DAN DENAH</h2>
						<hr class="primary">
						<p style="text-align:justify;text-indent:0.5in;">
						Dinas Sosial, Tenaga Kerja, dan Transmigrasi terletak di Jalan Conge Desa Ngembalrejo, Kecamatan Bae, Kabupaten Kudus. 
						Berikut adalah peta lokasi Dinas Sosial Tenaga Kerja dan Transmigrasi Kabupaten Kudus<br />
						<div id="map" style="width: 900px; height: 450px;"></div>
						<script type="text/javascript">
							// menentukan koordinat titik tengah peta
						  var myLatlng = new google.maps.LatLng(-6.794968, 110.878574);
						...
						//menambahkan marker
						  var marker = new google.maps.Marker({
							   position: myLatlng,
							   map: map,
							   title:"Dinas Sosial Tenaga Kerja dan Transmigrasi Kudus"
						  });
					</script> 
					</div>
				</div>
