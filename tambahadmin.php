...
require_once("koneksi.php");
	...
	$error_nama = $error_email = $error_password =  "";
	$nama = $email = $password =  ""; 
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a href="#" id="ihomebtn" class="navbar-brand"; style="color:#ffffff; font-family: Comic Sans MS;" >Sistem Informasi Pelayanan Sosial</a>
				</div>
