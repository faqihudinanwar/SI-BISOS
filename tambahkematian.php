<?php require_once("koneksi.php");
	...
	if (isset($_POST["submit"])){
		...
		if ($valid_nama && $valid_alamat && $valid_kecamatan && $valid_ahliwaris && $valid_volume && $hargasatuan){
			...
			$ahliwaris 		= $koneksi->real_escape_string($ahliwaris);
			$volume   		= $koneksi->real_escape_string($volume);
			$hargasatuan	= $koneksi->real_escape_string($hargasatuan);
						
			$query = "INSERT INTO kematian (nama, ahliwaris, alamat, idkec, volume, hargasatuan) VALUES ('".$nama."','".$ahliwaris."','".$alamat."','".$kecamatan."','".$volume."','".$hargasatuan."')";
