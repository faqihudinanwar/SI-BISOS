...
<html>
	...
	//Asign a query
	$query = " UPDATE file SET ".$tar." = '' WHERE idfile = '".$id."'";
	// Execute the query
	...
	if (!$result){
		...
		unlink($filename);
		if(!file_exists($dir."bedahrumah.pdf")){
			rmdir($dir);
		}
			echo '<h3><center> Data Berhasil Dihapus</center></h3>';
			echo'<center><a href = "posting_artikel.php" id="tombol">Kembali ke Artikel</a></center>';
		$db->close();
		exit;
	}
?>
