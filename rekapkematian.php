	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page-content-wrapper" style="background-color:#e8ecf0; font-family: Comic Sans MS;  ">
				...
				<!-- start: Table -->
            <div class="title" align="center"><h3>Rekapitulasi Data Kematian Tahun 2009 sd 2015<br> Kabupaten Kudus</h3></div>
			<br>
				<ul>
						<i class="glyphicon glyphicon-plus"></i>
						<a href="tambahrekapkematian.php">Tambah Data</a>
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th colspan="10"><center>Rincian</center></th>
				</tr>
				<tr>
					<th colspan="3"><center>Kematian Sakit / Tua</center></th>
					<th colspan="3"><center>Kecelakaan</center></th>
					<th><center>Jumlah</center></th>
					<th rowspan="2"><center>Jumlah Anggaran</center></th>
					<th colspan="2"><center>Aksi</center></th>
				</tr>
				<tr>
					<th ><center>Sakit / Tua</center></th>
					<th ><center>Harga Satuan</center></th>
					<th ><center>Jumlah</center></th>
					<th ><center>Kecelakaan</center></th>
					<th ><center>Harga Satuan</center></th>
					<th ><center>Jumlah</center></th>
		...
		//assign a query
		$query = "SELECT rekapkematian.idrekap, rekapkematian.tahun, rekapkematian.sakit, rekapkematian.satuansakit, rekapkematian.jumlahsakit, rekapkematian.kecelakaan, rekapkematian.satuankecelakaan, rekapkematian.jumlahkecelakaan, rekapkematian.total, rekapkematian.anggaran FROM rekapkematian ORDER BY idrekap ";
		//execute the query
		...
		echo '<td><center>'.$row->sakit.'</center></td>';
		echo '<td><center>'.$row->satuansakit.'</center></td>';
		echo '<td><center>'.$row->jumlahsakit.'</center></td>';
		echo '<td><center>'.$row->kecelakaan.'</center></td>';
		echo '<td><center>'.$row->satuankecelakaan.'</center></td>';
		echo '<td><center>'.$row->jumlahkecelakaan.'</center></td>';
		echo '<td><center>'.$row->total.'</center></td>';
		echo '<td><center>'.$row->anggaran.'</center></td>';
		echo '<td><center><a href="ubahkematian.php?id='.$row->idrekap.'">ubah </center></a></td>';
		echo '<td><center><a href="hapusrekapkematian.php?id='.$row->idrekap.'">Hapus </center></a></td>';
		echo '</tr>';
		$i++;
}
echo '</table>';
